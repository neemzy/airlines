    ...
    module.exports = React.createClass({
        ...
        render: function() {
            var estimate = this.props.estimate.toFixed(3),
                ...
                isOverConsumed = parseInt(consumed) > parseInt(estimate),
                wasUnderEstimated = parseInt(consumed) + parseInt(remaining) > parseInt(estimate),
                wasOverEstimated = parseInt(consumed) + parseInt(remaining) < parseInt(estimate),
                handleEstimateInput,
                handleConsumedInput,
