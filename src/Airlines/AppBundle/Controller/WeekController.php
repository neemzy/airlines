...
use Airlines\AppBundle\Entity\Week;
use Airlines\AppBundle\Form\WeekType;
...
class WeekController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AirlinesAppBundle:Week')->findAll();
     ...
     *
     * @Route("/", name="week_create")
     * @Method("POST")
     * @Template("AirlinesAppBundle:Week:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AirlinesAppBundle:Week')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="week_update")
     * @Method("PUT")
     * @Template("AirlinesAppBundle:Week:edit.html.twig")
     */
