...
use Airlines\AppBundle\Form\TaskType;
...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AirlinesAppBundle:Task')->findAll();
     ...
     * @Method("POST")
     * @Template("AirlinesAppBundle:Task:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("AirlinesAppBundle:Task:edit.html.twig")
     */
